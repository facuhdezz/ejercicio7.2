...
fetch(DATA_URL).then(response=>response.json()) //Se hace un fetch a la dirección y se espera que termine para convertir "response" en json
.then(data => {                                 //Luego de convertido se genera la función "data" que llama a la función showData con la información de students como parámetro
